...
{
     // Si auune session n'est démarrée pour le moment...
...
/**
 * Détermine s'il y a un message flash en session ou non
 ...
 * @return null|string Le message ou null
 */
function fetchFlash(): ?string
{
    ...
    if (hasFlash()) {
        ...
        // unset($_SESSION['flashbag']); // version 1
        $_SESSION['flashbag'] = null; // version 2
    }
